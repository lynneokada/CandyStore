...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        Candy *candy1 = [Candy new];
        candy1.candyName = @"Candy 1";
        //twix.candyImage = @"Note 1 Content";
        
        Candy *candy2 = [Candy new];
        candy2.candyName = @"Candy 2";
        //note2.content = @"Candy 2 Content";
        
        Candy *candy3 = [Candy new];
        candy3.candyName = @"Candy 3";
        //note3.content = @"Note 3 Content";
        
        _candyList = [@[candy1, candy2, candy3] mutableCopy];
    }
